...
from libs.prompt_toolkit.filters import to_cli_filter, ViInsertMode, EmacsInsertMode
from libs.prompt_toolkit.mouse_events import MouseEvent, MouseEventType
from libs.prompt_toolkit.reactive import Integer
from libs.prompt_toolkit.token import Token
from libs.prompt_toolkit.utils import take_using_weights, get_cwidth
...
class Container(with_metaclass(ABCMeta, object)):
    ...
    def preferred_width(self, cli, max_available_width):
        """
        Return a :class:`~libs.prompt_toolkit.layout.dimension.LayoutDimension` that
        represents the desired width for this container.

        :param cli: :class:`~libs.prompt_toolkit.interface.CommandLineInterface`.
        """
    ...
    def write_to_screen(self, cli, screen, mouse_handlers, write_position):
        ...
        :param cli: :class:`~libs.prompt_toolkit.interface.CommandLineInterface`.
        :param screen: :class:`~libs.prompt_toolkit.layout.screen.Screen`
        :param mouse_handlers: :class:`~libs.prompt_toolkit.layout.mouse_handlers.MouseHandlers`.
        """
...
class HSplit(Container):
    ...
    def write_to_screen(self, cli, screen, mouse_handlers, write_position):
        ...
        :param screen: The :class:`~libs.prompt_toolkit.layout.screen.Screen` class
...
class WindowRenderInfo(object):
    ...
    :class:`~libs.prompt_toolkit.layout.controls.BufferControl`) and the actual
...
class Window(Container):
    ...
    :param content: :class:`~libs.prompt_toolkit.layout.controls.UIControl` instance.
    :param width: :class:`~libs.prompt_toolkit.layout.dimension.LayoutDimension` instance.
    :param height: :class:`~libs.prompt_toolkit.layout.dimension.LayoutDimension` instance.
    ...
    :param left_margins: A list of :class:`~libs.prompt_toolkit.layout.margins.Margin`
        instance to be displayed on the left. For instance:
        :class:`~libs.prompt_toolkit.layout.margins.NumberredMargin` can be one of
    ...
    :param allow_scroll_beyond_bottom: A `bool` or
        :class:`~libs.prompt_toolkit.filters.CLIFilter` instance. When True, allow
    ...
    :param wrap_lines: A `bool` or :class:`~libs.prompt_toolkit.filters.CLIFilter`
    ...
    :param always_hide_cursor: A `bool` or
        :class:`~libs.prompt_toolkit.filters.CLIFilter` instance. When True, never
        display the cursor, even when the user control specifies a cursor
        position.
    :param cursorline: A `bool` or :class:`~libs.prompt_toolkit.filters.CLIFilter`
        instance. When True, display a cursorline.
    :param cursorcolumn: A `bool` or :class:`~libs.prompt_toolkit.filters.CLIFilter`
