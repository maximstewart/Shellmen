...
class AcceptAction(object):
    ...
    :param handler: (optional) A callable which takes a
        :class:`~libs.prompt_toolkit.interface.CommandLineInterface` and
        :class:`~libs.prompt_toolkit.document.Document`. It is called when the user
        accepts input.
    """
...
class Buffer(object):
    ...
    :param is_multiline: :class:`~libs.prompt_toolkit.filters.SimpleFilter` to
    ...
    :param complete_while_typing: :class:`~libs.prompt_toolkit.filters.SimpleFilter`
        instance. Decide whether or not to do asynchronous autocompleting while
        typing.
    :param enable_history_search: :class:`~libs.prompt_toolkit.filters.SimpleFilter`
    ...
    :param read_only: :class:`~libs.prompt_toolkit.filters.SimpleFilter`. When True,
    ...
    def document(self):
        """
        Return :class:`~libs.prompt_toolkit.document.Document` instance from the
    ...
    def document(self, value):
        """
        Set :class:`~libs.prompt_toolkit.document.Document` instance.
    ...
    def set_document(self, value, bypass_readonly=False):
        """
        Set :class:`~libs.prompt_toolkit.document.Document` instance. Like the
    ...
    def document_for_search(self, search_state):
        """
        Return a :class:`~libs.prompt_toolkit.document.Document` instance that has
        the text/cursor position for this search, if we would apply it. This
        will be used in the
        :class:`~libs.prompt_toolkit.layout.controls.BufferControl` to display
